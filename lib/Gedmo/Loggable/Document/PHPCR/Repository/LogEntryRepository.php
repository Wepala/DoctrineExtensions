...
namespace Gedmo\Loggable\Document\PHPCR\Repository;

use Gedmo\Tool\Wrapper\MongoDocumentWrapper;
use Gedmo\Loggable\LoggableListener;
use Doctrine\ODM\PHPCR\DocumentRepository;
use Doctrine\ODM\PHPCR\Cursor;
use Gedmo\Tool\Wrapper\PHPCRDocumentWrapper;
...
class LogEntryRepository extends DocumentRepository
{
    ...
    {
        return $this->dm->getAllLinearVersions($document);
    }
