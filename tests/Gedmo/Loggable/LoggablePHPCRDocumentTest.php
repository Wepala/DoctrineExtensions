 ...
 */
class LoggablePHPCRDocumentTest extends BaseTestCasePHPCRODM
{
    const ARTICLE = 'Loggable\\Fixture\\Document\\PHPCR\\Article';
    const COMMENT = 'Loggable\\Fixture\\Document\\PHPCR\\Comment';
    const RELATED_ARTICLE = 'Loggable\\Fixture\\Document\\PHPCR\\RelatedArticle';
    const COMMENT_LOG = 'Loggable\\Fixture\\Document\\PHPCR\\Log\\Comment';
    ...
    {
        $logRepo = $this->dm->getRepository('Gedmo\\Loggable\\Document\\PHPCR\\LogEntry');
